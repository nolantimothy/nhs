      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-[280px_1fr] lg:gap-8">
          ...
          <aside className="mb-8 lg:mb-0">
            <div className="sticky top-24 space-y-6 glass-card rounded-2xl p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${
                    instantBookOnly ? "bg-primary" : "bg-white/10"
                  }`}
                >
                  <span
          ...
          <div>
            ...
            {filteredVehicles.length > 0 ? (
              ...
              <div className="rounded-2xl border border-dashed border-white/10 py-20 text-center">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#475569" strokeWidth="1.5" strokeLinecap="round" className="mx-auto">
                  <circle cx="11" cy="11" r="8" />
                  <line x1="21" y1="21" x2="16.65" y2="16.65" />
                </svg>
                <h3 className="mt-4 text-lg font-semibold text-foreground">No cars found</h3>
                <p className="mt-2 text-sm text-slate-500">Try adjusting your filters to see more results.</p>
              </div>
            )}
          </div>
        </div>
